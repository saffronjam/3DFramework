...
void StartupLayer::OnAttach(Shared <BatchLoader> &loader) {
    m_TextureStore["Checkerboard"] = Texture2D::Create("Resources/Assets/Editor/Checkerboard.tga");
    m_TextureStore["SelectorBG"] = Texture2D::Create("Resources/Assets/Editor/SelectorBG.png");
}

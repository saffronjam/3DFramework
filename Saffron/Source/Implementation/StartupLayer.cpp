...
{
	m_TextureStore["Checkerboard"] = Factory::Create<Texture2D>("Resources/Assets/Editor/Checkerboard.tga");
	m_TextureStore["SelectorBG"] = Factory::Create<Texture2D>("Resources/Assets/Editor/SelectorBG.png");
}

...
void StartupLayer::OnAttach(Shared <BatchLoader> &loader) {
    m_TextureStore["Checkerboard"] = Texture2D::Create("res/Assets/Editor/Checkerboard.tga");
    m_TextureStore["SelectorBG"] = Texture2D::Create("res/Assets/Editor/SelectorBG.png");
}

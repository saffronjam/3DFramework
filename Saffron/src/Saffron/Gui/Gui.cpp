...
void Gui::Init()
{
	...
	auto *newFont = AddFont("res/Assets/Fonts/segoeui.ttf", 18);
	io.FontDefault = newFont;
	m_CurrentFont = { 18, newFont };

	AddFont("res/Assets/Fonts/segoeui.ttf", 8);
	AddFont("res/Assets/Fonts/segoeui.ttf", 12);
	AddFont("res/Assets/Fonts/segoeui.ttf", 14);
	AddFont("res/Assets/Fonts/segoeui.ttf", 20);
	AddFont("res/Assets/Fonts/segoeui.ttf", 22);
	AddFont("res/Assets/Fonts/segoeui.ttf", 24);
	AddFont("res/Assets/Fonts/segoeui.ttf", 28);
	AddFont("res/Assets/Fonts/segoeui.ttf", 32);
	AddFont("res/Assets/Fonts/segoeui.ttf", 56);
	AddFont("res/Assets/Fonts/segoeui.ttf", 72);

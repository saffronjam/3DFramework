...
[[maybe_unused]] static const std::string DefaultEntityName = "Entity";
...
///////////////////////////////////////////////////////////////////////////
/// Physics implementation, TODO: MOVE TO OTHER FILE!
///////////////////////////////////////////////////////////////////////////
...
void Scene::OnUpdate(Time ts)
{
	// Update all entities
	{
		...
		{
			const UUID entityID = m_Registry.get<IDComponent>(entity).ID;

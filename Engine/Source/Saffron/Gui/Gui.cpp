...
bool Gui::Property(const String& name, int& value, int min, int max, float step, PropertyFlag flags)
{
	...
	const String id = "##" + name;
	bool changed;
	if (flags == PropertyFlag::Slider) changed = ImGui::SliderInt(id.c_str(), &value, min, max);
	else changed = ImGui::DragInt(id.c_str(), &value, step, min, max);
...
bool Gui::Property(const String& name, float& value, float min, float max, float step, PropertyFlag flags)
{
	...
	const String id = "##" + name;
	bool changed;
	if (flags == PropertyFlag::Slider) changed = ImGui::SliderFloat(id.c_str(), &value, min, max);
	else changed = ImGui::DragFloat(id.c_str(), &value, step, min, max);
...
bool Gui::Property(const String& name, Vector2f& value, float min, float max, float step, PropertyFlag flags)
{
	...
	const String id = "##" + name;
	bool changed;
	if (flags == PropertyFlag::Slider) changed = ImGui::SliderFloat2(id.c_str(), glm::value_ptr(value), min, max);
	else changed = ImGui::DragFloat2(id.c_str(), glm::value_ptr(value), step, min, max);
                   ...
                   Optional<Function<void()>> fn)
{
	...
	else if (flags == PropertyFlag::Slider) changed = ImGui::SliderFloat3(id.c_str(), glm::value_ptr(value), min, max);
	else changed = ImGui::DragFloat3(id.c_str(), glm::value_ptr(value), step, min, max);
...
bool Gui::Property(const String& name, Vector4f& value, float min, float max, float step, PropertyFlag flags)
{
	...
	else if (flags == PropertyFlag::Slider) changed = ImGui::SliderFloat4(id.c_str(), glm::value_ptr(value), min, max);
	else changed = ImGui::DragFloat4(id.c_str(), glm::value_ptr(value), step, min, max);

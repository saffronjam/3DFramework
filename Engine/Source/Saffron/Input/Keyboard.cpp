...
Keyboard::Keyboard()
{
	...
	window.KeyPressed += SE_EV_FUNCTION(OnKeyPressed);
	window.KeyReleased += SE_EV_FUNCTION(OnKeyReleased);
	window.KeyRepeated += SE_EV_FUNCTION(OnKeyRepeated);
	window.TextInput += SE_EV_FUNCTION(OnTextInput);
}
